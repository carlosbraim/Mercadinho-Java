...
public class ViewJTable extends javax.swing.JFrame {
    ...
    public ViewJTable() {
        ...
        jTProdutos.setRowSorter(new TableRowSorter(modelo));//ordenar tabela
...
//        dtmProdutos.addRow(dados);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (jTProdutos.getSelectedRow() != -1) {
            ...
            p.setId((int)jTProdutos.getValueAt(jTProdutos.getSelectedRow(), 0));//pegando o valor da coluna
            dao.delete(p);
...
//            jTProdutos.setValueAt(txtPreco.getText(),jTProdutos.getSelectedRow(), 2);
    ...
    private void jTProdutosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTProdutosMouseClicked
        // TODO add your handling code here:
        if(jTProdutos.getSelectedRow() != -1){ // ao clicar no elemento da lita o memso aparece nos campos para atualização
    ...
    public static void main(String args[]) {
        /* Set the Nimbus look and feel */ //abaixo é feito a edição do aplicativo view
